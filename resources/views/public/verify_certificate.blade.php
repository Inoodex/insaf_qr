...
<body>
    ...
    <main class="main-content">
        ...
        <div class="row g-3">
            ...
            <!-- 1. Account No (Blue) -->
            <div class="col-md-6">
                <div class="detail-card accent-blue" title="{{ $certificate->account_no }}">
                    <span class="card-title-text">Account No</span>
                    <div class="card-value-text">{{ $certificate->account_no }}</div>
                </div>
            </div>

            <!-- 2. Account Name (Red) -->
            <div class="col-md-6">
                <div class="detail-card accent-red" title="{{ $certificate->account_name }}">
                    <span class="card-title-text">Account Name</span>
                    <div class="card-value-text">{{ $certificate->account_name }}</div>
                </div>
            </div>

            <!-- 3. Report Date Balance (Green) -->
            <div class="col-md-6">
                <div class="detail-card accent-green" title="{{ $certificate->formatted_balance }}">
                    <span class="card-title-text">Report Date Balance</span>
                    <div class="card-value-text">{{ $certificate->formatted_balance }}</div>
                </div>
            </div>

            <!-- 4. Report Generation Date (Blue) -->
            <div class="col-md-6">
                <div class="detail-card accent-blue" title="{{ $certificate->formatted_generation_date }}">
                    <span class="card-title-text">Report Generation Date</span>
                    <div class="card-value-text">{{ $certificate->formatted_generation_date }}</div>
                </div>
            </div>
